...
import OperationsBurnPage from '@/app/dashboard/operations/burn/page';
...
const renderSignInPageWithProviders = () => renderWithProviders(<OperationsBurnPage />);

let renderResult: RenderResult;

describe('Operations/Burn page:', () => {
  afterAll(cleanup);

  describe('Operations/Burn page with connected state:', () => {
    beforeEach(() => {
      const domain = 'https://localhost:3001';
      const url = new URL(`${domain}/dashboard/operations/burn?${qs.stringify({
