...
export interface BalanceCell extends HTMLAttributes<HTMLDivElement> {
  accountAddress: string;
  currentStableCoin: StableCoin;
  loaderClassName?: string;
}

export const BalanceCell: FC<BalanceCell> = ({ accountAddress, currentStableCoin, loaderClassName, ...props }) => {
  const {
